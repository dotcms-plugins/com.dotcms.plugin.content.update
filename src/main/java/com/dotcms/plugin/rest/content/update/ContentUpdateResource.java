...
public class ContentUpdateResource {
    ...
    public Response loadJson(UpdateRequest updateRequest)
            throws DotStateException, DotDataException, DotSecurityException, JsonProcessingException {
    ...
    @Path("/test")
    @Produces(MediaType.APPLICATION_JSON)
    public Response test() throws DotStateException, DotDataException, DotSecurityException, JsonProcessingException {
        // force authentication
        InitDataObject auth = webResource.init(false, httpRequest, false);
